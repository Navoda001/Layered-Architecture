    ...
    private void searchItem() {
        ...
        try {
            ...
            if (itemDto != null) {
                ...
                txtUnitPrice.setText(Double.toString(itemDto.getUnitPrize()));
    ...
    private void loadTable() {
        try {
            ...
            if (itemDtos != null){
                ...
                Object[] rowData = {itemDto.getItemCode(), itemDto.getDescription(), itemDto.getPackSize(), itemDto.getUnitPrize(), itemDto.getQoh()};
                dtm.addRow(rowData);
            }
            }
