...
import edu.ijse.layerd.controller.OrdeController;
...
public class OrderView extends javax.swing.JFrame {
    ...
    private void searchItem() {
        ...
        try {
            ...
            ItemDto itemDto = itemcontroller.search(itemId);
            if (itemDto != null) {
                lblItemData.setText(itemDto.getItemCode() + " | " + itemDto.getDescription() + " | " + itemDto.getQoh() + " | " + itemDto.getUnitPrize());
            } else {
    ...
    private void addToTable() {
        OrderDetailDto orderDetailDto = new OrderDetailDto(txtItemId.getText(), Double.parseDouble(txtDiscount.getText()), Integer.parseInt(txtQty.getText()));
